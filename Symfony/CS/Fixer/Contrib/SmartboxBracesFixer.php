...
/**
 * Fixer for Smartbox bracketing rules based on Symfony\CS\Fixer\PSR2\BracesFixer.php
 *
 * @author Piotr Dabrowiecki
 */
class SmartboxBracesFixer extends AbstractFixer
{
    /**
     * {@inheritdoc}
     */
